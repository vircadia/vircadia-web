...
import { IEntity, IEntityDescription, EntityBuilder, EntityEvent, DEFAULT_MESH_RENDER_GROUP_ID } from "@Modules/entity";
import { GameObject, MeshComponent, CapsuleColliderComponent } from "@Modules/entity/components";
